<?php
    ...
    if( isset( $_POST ) ){
        ...
        //     header("Location: Final Project\index.php?valid=$error");
        // }
        //     // else {
        //     //     if ($this_user['role'] == 1) {
        //     //         header("Location: /Final Project/admin/admin_index.php"); // Admin
        //     //     } else {
        //     //         header("Location: /Final Project/index.php"); // User
        //     //     }
        //     //     exit;
        //     // }
    }
